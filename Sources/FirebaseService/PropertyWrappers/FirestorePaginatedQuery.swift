//
//  FirestorePaginatedQuery.swift
//  
//
//  Created by Alex Nagy on 18.01.2023.
//
...
@propertyWrapper
public struct FirestorePaginatedQuery<T, U: Codable & Firestorable & Equatable, C: Comparable>: DynamicProperty {
    @StateObject public var manager: FirestorePaginatedQueryManager<T, U, C>
    ...
    public init(_ collectionPath: String,
        ...
        _manager = StateObject(wrappedValue: FirestorePaginatedQueryManager<T, U, C>(configuration: configuration))
    }
}

final public class FirestorePaginatedQueryManager<T, U: Codable & Firestorable & Equatable, C: Comparable>: ObservableObject {
    ...
    internal var configuration: FirestorePaginatedQuery<T, U, C>.Configuration<U> {
        didSet {
    ...
    public init(configuration: FirestorePaginatedQuery<T, U, C>.Configuration<U>) where T == [U] {
        self.value = [U]()
